...
\begin{problem}
Write a function that takes a black and white image as input and outputs a list of the edges and corresponding weights. Store the edges using the form \li{(node,node,weight)}.
...
\begin{figure}[H]
\includegraphics[width = .4\textwidth]{MSTseg1.jpg}
\caption{MSTseg1.jpg}
\end{figure}
