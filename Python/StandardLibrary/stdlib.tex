...
The file \li{output.txt} is the name of the file you should have passed in from Problem \ref{prob:prob2} using the \li{sys} module. Write to the file the names of the survivors along with what events they survived, as well as the names of those who didn't survive and their associated events.
